...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : lun. 19 sep. 2022 à 08:08
...
CREATE TABLE IF NOT EXISTS `amphitheatre` (
  `id_amphitheatre` int(11) NOT NULL,
...
ALTER TABLE `conference`
  ADD CONSTRAINT `conference_ibfk_1` FOREIGN KEY (`ref_amphitheatre`) REFERENCES `amphitheatre` (`id_amphitheatre`);
